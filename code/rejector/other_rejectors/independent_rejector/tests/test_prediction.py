...
class TestPrediction(unittest.TestCase):
    ...
    def test_set_of_tps(self):
        self.assertEqual(Prediction.set_of_tps(self.predictions), [
            Prediction("positive", "positive", 0.8, "positive", None)])

    def test_set_of_tns(self):
        self.assertEqual(Prediction.set_of_tns(self.predictions), [
            Prediction("negative", "negative", 0.8, "positive", None)])

    def test_set_of_fps(self):
        self.assertEqual(Prediction.set_of_fps(self.predictions), [
