...
class PDF():
    ...
    def __init__(self, predictions: List[Prediction], fraction: float, kde: sm.nonparametric.KDEMultivariate) -> None:
        """
        Args:
            ...
            kde (sm.nonparametric.KDEMultivariate): The KernelDensity estimator.
        """
        if kde != None:
