...
%	THESIS INFORMATION
%----------------------------------------------------------------------------------------
\thesistitle{Value-Sensitive Rejection of Machine Decisions for Hate Speech Detection} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\input{Chapters/value-sensitive metric.tex}
\input{Chapters/survey study.tex}
