...
%
We apply either ANOVA (parametric) or Kruskal-Wallis (non-parametric) when we have more than two groups and apply an unpaired two-samples t-test (parametric) or the Mann-Whitney U Test (non-parametric) when we have exactly two groups.
%
...
%
ANOVA requires three conditions:
\todo[inline]{Refer to book Statistical Methods for Psychology}