...
%
Prolific provides information about the demographic characteristics of the participants, out of which we analyze six variables based on what Prolific provides us in the survey results: sex, student (whether they are still a student or not), continent, nationality, language, and ethnicity.
%
We manually add the continent variable based on the values of the nationality variable.
%
We exclude age as almost all participants' ages fall between 20 and 30 years old.
%
We have multiple groups (more than two) for nationality, ethnicity, and  (different age intervals) and two groups for the variables student and gender.
%
...
%
Finally, for the multi-group variables (nationality, language, and ethnicity), we apply pairwise statistical tests (Mann-Whitney U or t-test) between all groups.
%
