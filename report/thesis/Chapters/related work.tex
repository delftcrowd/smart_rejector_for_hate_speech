...
In this work, we apply the dependent way since it allows for using the reject option in any existing classification model \citep{hendrickx2021machine}.
%
...
%
Therefore, we abstain from estimating the values from the companies' perspective as stakeholder.

Second, we look at the social media users as stakeholder.
%
