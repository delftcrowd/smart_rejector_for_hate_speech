...
This section briefly defines hate speech and why it is such a challenging topic to tackle, especially in computer science. Then, we give an overview of some algorithms we can use to detect hate speech automatically.
