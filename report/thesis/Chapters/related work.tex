...
\begin{figure}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[scale=.80]{Figures/scale-likert.pdf}
        \caption{Likert}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[scale=.80]{Figures/scale-100.pdf}
        \caption{100-level}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[scale=.80]{Figures/scale-me.pdf}
        \caption{ME}
        \label{fig:scales-me}
    \end{subfigure}
...
%
This way, all magnitudes estimates are in the range [-1, 1] while maintaining the ratio properties.
%
