...
%
For this reason, we only calculate the total value of all predictions for the range $\tau \in [0.5, 1.0]$.
%
If $\tau = 1.0$, then we reject all predictions.
%
\todo[inline]{Explain how we compare the metric to machine metrics such as accuracy}