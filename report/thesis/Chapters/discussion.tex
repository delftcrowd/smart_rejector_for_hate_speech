...
%
However, the results do show that people with different nationalities, languages, and ethnicities are more likely to differ in their opinions about hate speech detection scenarios than people with different sex or student status.
%
...
%
Also, we found that hateful social media posts are more sensitive to cause group differences than non-hateful posts, as the results showthat there are more scenarios with group differences when they contain hateful posts (10 in total) than non-hateful posts (5 in total).
%
