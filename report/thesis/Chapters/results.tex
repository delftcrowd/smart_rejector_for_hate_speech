...
\begin{table}
    ...
    \begin{tabular}{ccccc}
        ...
        \textbf{Poland}       & 0.068                                     & 1.000                                  &                           &                           \\
        \textbf{Portugal}     & 0.141                                     & \cellcolor[HTML]{EFEFEF}\textbf{0.000} & \multicolumn{1}{r}{1.000} &                           \\
        \textbf{Spain}        & 0.068                                     & \cellcolor[HTML]{EFEFEF}\textbf{0.000} & \multicolumn{1}{r}{0.513} & \multicolumn{1}{r}{1.000} \\
        \bottomrule
    \end{tabular}
...
\begin{table}
    ...
    \begin{tabular}{ccccc}
        ...
        \midrule
        \textbf{South Africa} & 1.000                                     & \multicolumn{1}{l}{}                &                           &                           \\
        \textbf{Poland}       & 0.193                                     & 1.000                               &                           &                           \\
        \textbf{Portugal}     & 0.680                                     & 0.193                               & \multicolumn{1}{r}{1.000} &                           \\
        \textbf{Spain}        & 0.193                                     & 0.104                               & \multicolumn{1}{r}{0.193} & \multicolumn{1}{r}{1.000} \\
        \bottomrule
    \end{tabular}
...
\begin{table}
    ...
    \begin{tabular}{ccccc}
        ...
        \midrule
        \textbf{South Africa} & 1.000                                     & \multicolumn{1}{l}{}                   &                                    &                           \\
        \textbf{Poland}       & 1.000                                     & 1.000                                  &                                    &                           \\
        \textbf{Portugal}     & 0.465                                     & 0.465                                  & \multicolumn{1}{r}{1.000}          &                           \\
        \textbf{Spain}        & \cellcolor[HTML]{EFEFEF}\textbf{0.004}    & \cellcolor[HTML]{EFEFEF}\textbf{0.014} & \multicolumn{1}{r}{\textbf{0.024}} & \multicolumn{1}{r}{1.000} \\
        \bottomrule
    \end{tabular}
...
\begin{table}
    ...
    \begin{tabular}{ccccc}
        ...
        \midrule
        \textbf{South Africa} & 1.000                                     & \multicolumn{1}{l}{}                &                           &                           \\
        \textbf{Poland}       & 0.315                                     & 1.000                               &                           &                           \\
        \textbf{Portugal}     & 0.287                                     & 1.000                               & \multicolumn{1}{r}{1.000} &                           \\
        \textbf{Spain}        & 0.080                                     & 0.287                               & \multicolumn{1}{r}{0.287} & \multicolumn{1}{r}{1.000} \\
        \bottomrule
    \end{tabular}
...
\begin{table}
    ...
    \begin{tabular}{ccccc}
        ...
        \midrule
        \textbf{South Africa} & 1.000                                     & \multicolumn{1}{l}{}                &                           &                           \\
        \textbf{Poland}       & 0.115                                     & 1.000                               &                           &                           \\
        \textbf{Portugal}     & 0.194                                     & 1.000                               & \multicolumn{1}{r}{1.000} &                           \\
        \textbf{Spain}        & 0.085                                     & 0.506                               & \multicolumn{1}{r}{0.506} & \multicolumn{1}{r}{1.000} \\
        \bottomrule
    \end{tabular}
...
\begin{table}
    ...
    \begin{tabular}{ccccc}
        ...
        \midrule
        \textbf{South Africa} & 1.000 & \multicolumn{1}{l}{} &  &  \\
\textbf{Poland} & 0.099 & 1.000 &  &  \\
\textbf{Portugal} & \cellcolor[HTML]{EFEFEF}\textbf{0.045} & \cellcolor[HTML]{EFEFEF}\textbf{0.001} & \multicolumn{1}{r}{1.000} &  \\
\textbf{Spain} & 0.099 & \cellcolor[HTML]{EFEFEF}\textbf{0.017} & \multicolumn{1}{r}{1.000} & \multicolumn{1}{r}{1.000} \\
        \bottomrule
    \end{tabular}
