...
%
The goals of the experiments with the value-sensistive rejector are finding out how the rejector behaves on different models and datasets, if rejection is beneficial for hate speech detection, and comparing the value-sensitive metric against machine metrics such as accuracy.
%
